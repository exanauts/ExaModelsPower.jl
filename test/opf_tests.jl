function test_case3(result, result_pm, dicts, pg, qg, p, q)
    test_static_case(result, result_pm, dicts, pg, qg)
...
function test_static_case(result, result_pm, dicts, pg, qg)
...
function test_case5(result, result_pm, dicts, pg, qg, p, q)
    test_static_case(result, result_pm, dicts, pg, qg)
end

function test_case14(result, result_pm, dicts, pg, qg, p, q)
    test_static_case(result, result_pm, dicts, pg, qg)
end
